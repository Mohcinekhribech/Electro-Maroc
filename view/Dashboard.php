...
<div class="sideBar transition-all duration-300 ease-linear w-[60px] flex flex-col h-screen p-2 top-0 bg-sky-900 px-2 border-r border-gray-700 relative">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
    ...
    <div class="flex flex-col items-center mt-6 -mx-2">
        <img src="public/img/Profile/321059533_1093486834655909_8466472925953741460_n.jpg" class="image object-cover w-24 h-24  mx-2 rounded-full h-8 w-8" alt="Avatar" />
        <h4 class="side hidden mx-2 mt-2 font-medium text-white">Mohcine Khribech</h4>
    </div>
