...
<body class="relative">
    <header>
        <nav class="flex h-14 z-10 text-gray-200 justify-between top-0 bg-sky-900 fixed w-full font-medium">
            ...
            <div class="flex mx-10  justify-between">
                ...
                <?php } else { ?>
                    <a href="?p=Login" class="my-auto hover:bg-gray-200 hover:text-sky-900 text-sm  border rounded-sm border-solid border-gray-200  transition ease-linear max-lg:w-fit flex  px-5 max-lg:px-2 py-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 max-lg:pr-0 pr-2">
                    ...
                    <a href="?p=inscription" class="my-auto w-fit hover:bg-amber-300 text-amber-300 hover:text-sky-900 text-sm border rounded-sm max-lg:px-2 border-solid border-amber-300 transition ease-linear  px-5 py-1 flex">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 max-lg:pr-0 pr-2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
                        </svg>
                        <span class="max-lg:hidden">Inscription</span>
