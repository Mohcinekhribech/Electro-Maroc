    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      foreach ($post as $key => $value) { ?>
        <tr>
                ...
                <img class="w-10 h-10 rounded-full" src="<?= $value['categoryPic'] ?>" alt="Category image">
                </th>
                <th scope="col" class="px-6 py-3">
                    Category
                </th>
                <th scope="col" class="text-light text-sm overflow-auto">
                  <p class="overflow-y-auto max-h-20 font-light text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus exercitationem unde ad beatae pariatur deleniti neque hic. 
</p>
                </th>
                <th scope="col" class="px-6 py-3">
                    0
