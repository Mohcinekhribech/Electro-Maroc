...
?>
<div class="w-full sm:px-6 mt-40">
        ...
        <div class="px-4 md:px-10 py-4 md:py-7 bg-gray-100  rounded-tl-lg rounded-tr-lg">
            <div class="sm:flex items-center justify-between">
                ...
                <div class="flex max-sm:flex-col">
                    ...
                    <button type="submit" class="focus:ring-2 w-fit focus:ring-offset-2 focus:ring-sky-600 inline-flex sm:ml-3 mt-4 sm:mt-0 items-start justify-start px-6 py-3 bg-sky-700 hover:bg-sky-600 focus:outline-none rounded">
                        <p class="text-sm font-medium leading-none text-white">Confirm Order</p>
                    </button>
                </div>
            </div>
        </div>
            ...
            <table class="w-full whitespace-nowrap">
                ...
                <tbody class="w-full">
                    ...
                    foreach ($post as $key => $value) {
                        if ($value['hide'] == 0) {
                    ?>
                            <tr tabindex="0" class="focus:outline-none h-20 text-sm leading-none text-gray-800  bg-white   hover:bg-gray-100 ay-900  border-b border-t border-gray-100 -700 ">
                                <td class="pl-4 cursor-pointer">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10">
                                            <img class="w-full h-full" src="<?= $value['productPic'] ?>" alt="UX Design and Visual Strategy" />
                                        </div>
                                        <div class="pl-4">
                                ...
                                <td class="pl-12">
                                    <input class="quan text-sm border w-20 font-medium leading-none text-gray-800" type="number" value="1" min="1" placeholder="Quantite" name="quantite" id="">
                                </td>
                                <td class="pl-12">
                                    <p class="font-medium"> <span class="finalPrice"><?= $value['finalPrice'] ?></span> DH</p>
                                </td>
                                <td class="pl-20">
                                    <a href="" class="text-red-600 hover:bg-red-200 p-2 rounded-lg font-medium">Cancel</a>
                                </td>
                            </tr>
                    <?php
                        }
